...
const contactUsPosition = elements.contactUsSection.getBoundingClientRect().top
console.log(contactUsPosition)
...
window.onscroll = () => {
  ...
  if (screen.width > 1480) {
    ...
    // }
  } else if (window.width < 768 || screen.width < 768) {
  ...
  if (pageYOffset + 250 >= contactUsPosition) {
