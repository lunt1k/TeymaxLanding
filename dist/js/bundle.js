...
__webpack_require__.r(__webpack_exports__);
var elements = {
  buttonsNav: document.querySelector('.slider-nav-block'),
...
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./elements */ "./js/elements.js");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slider */ "./js/slider.js");
/* harmony import */ var _scrollspy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scrollspy */ "./js/scrollspy.js");
/* harmony import */ var _toggle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./toggle */ "./js/toggle.js");
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./request */ "./js/request.js");
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_request__WEBPACK_IMPORTED_MODULE_7__);
...
function submitForm(e) {
  ...
  _toConsumableArray(formElements).forEach(function (item) {
    if (item.name) {
      postData = _objectSpread({}, postData, _defineProperty({}, item.name, item.value));
    }
  });
  ...
  var formData = new FormData(this); // formData.append('name', postData['name']);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch('http://localhost:9000/mail.php', {
              method: 'POST',
          ...
          case 9:
            ...
            status.innerHTML = _context.t0.message;
...
var videosURL = ['https://www.youtube.com/embed/T3zaF1BmFT0', 'https://www.youtube.com/embed/ea5uxRmRe8Y'];

var addToggle = function addToggle() {
  var navbar = document.getElementById('navbar');
  var paddingTopNav = parseInt(window.getComputedStyle(navbar, null).getPropertyValue('padding-top'));
...
var contactUsTopPosition = _elements__WEBPACK_IMPORTED_MODULE_1__["default"].contactUsSection.getBoundingClientRect().top + window.pageYOffset;
window.addEventListener('resize', function () {
  addToggle();
  contactUsTopPosition = _elements__WEBPACK_IMPORTED_MODULE_1__["default"].contactUsSection.getBoundingClientRect().top + window.pageYOffset;
});
window.addEventListener('load', function () {
  addToggle();
  setTimeout(function () {
    _toConsumableArray(_elements__WEBPACK_IMPORTED_MODULE_1__["default"].videoBlock).forEach(function (el, index) {
      el.src = "".concat(videosURL[index]);
    });
  }, 1000);
});
...
window.onscroll = function () {
  var navbar = document.getElementById('navbar');
  var navbarToggle = document.querySelector('toogle-menu');
  var paddingTopNav = parseInt(window.getComputedStyle(navbar, null).getPropertyValue('padding-top'));

  if (window.innerWidth > 1480) {
    // if (window.pageYOffset < 223) {
    navbar.style.paddingTop = '258px'; // } else if (paddingTopNav != 35) {
  ...
  if (window.pageYOffset + 300 >= contactUsTopPosition) {
    _elements__WEBPACK_IMPORTED_MODULE_1__["default"].navbar.classList.add('display-hide');
  } else {
    _elements__WEBPACK_IMPORTED_MODULE_1__["default"].navbar.classList.remove('display-hide');
  }
};

new smooth_scroll__WEBPACK_IMPORTED_MODULE_0___default.a('[data-scroll]', {
  speed: 1000,
  speedAsDuration: true,
  header: '[data-scroll-header]'
});

var sections = _toConsumableArray(_elements__WEBPACK_IMPORTED_MODULE_1__["default"].sections);

var sectionsTop = Array.prototype.map.call(sections, function (section) {
  return {
    id: section.id,
...
window.addEventListener('scroll', function () {
  var ACTIVE_CLASSNAME = 'navbar-collapse__link--active';
  var currScrollPosition = document.documentElement.scrollTop || document.body.scrollTop;
  sectionsTop.forEach(function (_ref) {
    var id = _ref.id,
        offsetTop = _ref.offsetTop;
    var positionTop = offsetTop - window.innerHeight / 2;

    if (positionTop <= currScrollPosition) {
      document.querySelector(".".concat(ACTIVE_CLASSNAME)).classList.remove(ACTIVE_CLASSNAME);
      document.querySelector("a[href*='".concat(id, "']")).parentElement.classList.add(ACTIVE_CLASSNAME);
    }
  });
}); // const spyScrolling = () => {
...
var modalTom = document.getElementById('modalTom');
var modalGeoff = document.getElementById('modalGeoff');
var modalDaniel = document.getElementById('modalDaniel'); // const btnTom = document.querySelectorAll('.modal-btn-tom');
// const btnGeoff = document.querySelectorAll('.modal-btn-geoff');
// const btnDaniel = document.querySelectorAll('.modal-btn-daniel');

var imgTom = document.querySelectorAll('.img--tom');
var imgGeoff = document.querySelectorAll('.img--geoff');
var imgDaniel = document.querySelectorAll('.img--daniel');
var span = document.querySelectorAll('.modal__close');
var iframe = document.querySelectorAll('iframe'); // [...btnTom].forEach((el) => {
...
_toConsumableArray(imgTom).forEach(function (el) {
  el.addEventListener('click', function () {
    modalTom.style.transform = 'translateY(0%)';
  });
});

_toConsumableArray(imgGeoff).forEach(function (el) {
  el.addEventListener('click', function () {
    modalGeoff.style.transform = 'translateY(0%)';
  });
});

_toConsumableArray(imgDaniel).forEach(function (el) {
  el.addEventListener('click', function () {
    modalDaniel.style.transform = 'translateY(0%)';
  });
});

_toConsumableArray(span).forEach(function (element) {
  element.addEventListener('click', function () {
    ...
    _toConsumableArray(iframe).forEach(function (element) {
...
window.onclick = function (event) {
  if (event.target == modalTom || event.target == modalGeoff || event.target == modalDaniel) {
    modalTom.style.transform = 'translateY(-100%)';
    modalGeoff.style.transform = 'translateY(-100%)';
    modalDaniel.style.transform = 'translateY(-100%)';
    emailModal.style.transform = 'translateY(-100%)';
...
var emailBtn = document.querySelector('.modal-email-btn');
var emailModal = document.getElementById('modalEmail');
var emailConfirmBtn = document.querySelector('.submit-email-btn');
emailBtn.addEventListener('click', function () {
  emailModal.style.transform = 'translateY(0%)';
});
emailConfirmBtn.addEventListener('click', function () {// const userName = document.getElementById('nameInput').value;
...
_elements__WEBPACK_IMPORTED_MODULE_0__["default"].menuBtn.addEventListener('click', function () {
  var scrollY = window.pageYOffset;
  var topValue = _elements__WEBPACK_IMPORTED_MODULE_0__["default"].body.getBoundingClientRect().top;
  _elements__WEBPACK_IMPORTED_MODULE_0__["default"].menuBtn.classList.toggle('open');
  _elements__WEBPACK_IMPORTED_MODULE_0__["default"].navItemsBlock.classList.toggle('display-show');

  if (_elements__WEBPACK_IMPORTED_MODULE_0__["default"].navItemsBlock.classList.contains('display-show')) {
    setTimeout(function () {
...
Array.from(_elements__WEBPACK_IMPORTED_MODULE_0__["default"].navLinks).forEach(function (element) {
  element.addEventListener('click', function () {
    _elements__WEBPACK_IMPORTED_MODULE_0__["default"].menuBtn.classList.remove('open');
    _elements__WEBPACK_IMPORTED_MODULE_0__["default"].navItemsBlock.classList.remove('display-show');
  });
});
